...
export default function CrimpAPage() {
  ...
  async function loadData() {
    ...
    try {
      const [rex, rcur] = await Promise.all([
        ...
        fetch(`/api/crimp-a?assemblyItem=${assemblyItem}`, {
          cache: "no-store",
        }),
      ]);
      ...
      if (!rcur.ok || !dcur?.ok)
        throw new Error(dcur?.error || "No se pudo obtener Crimp A");
      ...
      if (dcur.crimpA) {
        ...
        setCurv(
          dcur.crimpA.Curv ? String(dcur.crimpA.Curv).toUpperCase()[0] : "R"
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-green-100 dark:from-slate-950 dark:via-emerald-950 dark:to-green-950">
      ...
      <GlobalTopbar
        title="Crimp A"
        subtitle="Configuración de primer engaste"
        icon={Wrench}
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">
                    {isEditing
                      ? "Modifica los parámetros del primer engaste"
                      : "Define los parámetros del primer proceso de engaste"}
                  </p>
                </div>
              </div>
              <div className="hidden sm:block text-xs text-white/80 bg-white/15 px-3 py-2 rounded-lg backdrop-blur-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    El <b>Item</b> se agregará a <b>Adds[3]</b> al crear
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Ej. 10G-10FJX90M, 12GS-12FMX90-048"
                  required
              ...
              <div className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>
                  Ejemplos:{" "}
                  {examples.fittings.slice(0, 3).join(" • ") || "Cargando..."}
                </span>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <span>
                      Ejemplos:{" "}
                      {examples.crimps.slice(0, 3).join(" • ") ||
                        "NORMAL, ESPECIAL"}
                    </span>
                  </div>
                </div>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/20 dark:to-green-950/20 shadow-lg p-6">
          ...
          <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
            <li className="flex items-start gap-2">
              ...
              <span>
                El <strong>Item</strong> se agrega automáticamente como tercer
                elemento (<strong>Adds[3]</strong>) del Assembly al crear un
                nuevo registro.
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                Los campos <strong>Fitting</strong>,{" "}
                <strong>Min/Nom/Max</strong>, <strong>Curv</strong>,{" "}
                <strong>Dies</strong> y <strong>Crimp</strong> son todos
                obligatorios.
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                El campo <strong>Curv</strong> acepta solo una letra mayúscula
                (ej. R, S, T) y <strong>Crimp</strong> se convierte
