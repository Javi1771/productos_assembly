...
export default function SleeveGuardPage() {
  ...
  async function loadData() {
    ...
    try {
      const [rex, rcur] = await Promise.all([
        ...
        fetch(`/api/sleeve?assemblyItem=${assemblyItem}`, {
          cache: "no-store",
        }),
      ]);
      ...
      if (!rcur.ok || !dcur?.ok)
        throw new Error(dcur?.error || "No se pudo obtener Sleeve");
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      showSuccess(
        `${isEditing ? "Sleeve actualizado" : "Sleeve guardado"}${
          d.sleeve?.item ? ` (Item ${d.sleeve.item})` : ""
        }.`
      );
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950 grid place-items-center">
        <div className="text-center">
          ...
          <p className="text-slate-700 dark:text-slate-300 text-sm font-semibold">
            Cargando datos de Sleeve/Guard…
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950">
      ...
      <GlobalTopbar
        ...
        subtitle="Configuración de protección y manga"
        icon={Shield}
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-bold">
                    {isEditing
                      ? "Editar Sleeve/Guard"
                      : "Configurar Sleeve/Guard"}
                  </h2>
                  <p className="text-white/90 text-sm">
                    {isEditing
                      ? "Modifica los parámetros de protección"
                      : "Define los parámetros de sleeve y protección"}
                  </p>
                </div>
              </div>
              <div className="hidden sm:block text-xs text-white/80 bg-white/15 px-3 py-2 rounded-lg backdrop-blur-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    El <b>Item</b> se agregará a <b>Adds[2]</b> (opcional)
                  </span>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={onSubmit} className="p-8 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>
                  Si se especifica, se agregará a Adds[2]. Ejemplos:{" "}
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Ej. 24 HG BOBCAT, 16 HG BOBCAT, 24 HG 1.42 ID MLRO PBL"
              ...
              <div className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>
                  Ejemplos:{" "}
                  {examples.sleeves.slice(0, 3).join(" • ") || "Cargando..."}
                </span>
              </div>
            </div>
              ...
              <div className="p-4 rounded-xl bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800">
                <div className="flex items-center gap-2 text-red-700 dark:text-red-400">
                  ...
                  <p className="text-sm font-medium">
                    Los campos Min, Nom y Max son obligatorios para el
                    sleeve/guard
                  </p>
                </div>
              </div>
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    {isEditing
                      ? "Actualizar Sleeve/Guard"
                      : "Guardar Sleeve/Guard"}
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 shadow-lg p-6">
          ...
          <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
            <li className="flex items-start gap-2">
              ...
              <span>
                El campo <strong>Item</strong> es opcional. Si se especifica, se
                agregará como segundo elemento (<strong>Adds[2]</strong>) en el
                Assembly.
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                La <strong>descripción del Sleeve</strong> es opcional y puede
                incluir información sobre el tipo de protección.
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                ...
                <strong>Max</strong> son <em>obligatorias</em> y definen los
                parámetros de tolerancia del sleeve/guard.
              </span>
            </li>
          </ul>
        </div>
